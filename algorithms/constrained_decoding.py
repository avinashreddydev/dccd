...
class ConstrainedDecodingParams(BaseModel):
    model_name: str
    max_tokens: int = 8192
    ...
    save_name: str = "constrained_decoding"



class ConstrainedDecoding(BaseAlgorithm):
    """
    ...
    def __init__(self, 
        ...
        self.alg_name = "constrained_decoding"
    ...
    def set_task_system_prompt(self, task : str, **kwargs) -> str:
        ...
        if task == "prover9":
            ...
            for fewshot in PROVER9_SYSTEM_PROMPT_WITH_FEWSHOTS:
                self.chat_fewshots.append({"role": "user", "content": fewshot['question']})
                self.chat_fewshots.append({"role": "assistant", "content": fewshot['response']})
