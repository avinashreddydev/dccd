...
os.environ['PROVER9'] = "utils/Prover9"
os.environ['GRAMMAR_DIR'] = "utils"
...
class Grammar:
    ...
    def __init__(self, name):
        ...
        if os.path.exists(f'{os.environ["GRAMMAR_DIR"]}/prover9.lark'):
            grammar_filename = f'{os.environ["GRAMMAR_DIR"]}/prover9.lark'
        else:
