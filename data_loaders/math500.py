...
class Math500Loader(BaseLoader):
    def __init__(self, **kwargs):
        super().__init__()
        self.input_column = "problem"
        self.output_column = "solution"
    ...
    def load_data(self):
        ds = load_dataset("datasets/MATH500", split="test")
        data = ds
        self.data = [ex["problem"] for ex in data]
        self.ground_truths = [ex["solution"] for ex in data]
